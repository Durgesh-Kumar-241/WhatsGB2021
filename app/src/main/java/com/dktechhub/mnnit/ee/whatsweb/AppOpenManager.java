...
public class AppOpenManager implements  Application.ActivityLifecycleCallbacks {
    ...
    /** Request an ad */
        public void fetchAppOpeenAd() {
            ...
            AppOpenAd.load(
                    myApplication,myApplication.getString(R.string.app_open), request,
    ...
    public void fetchInterstitialAd() {
        ...
        AdRequest request = getAdRequest();
        InterstitialAd.load(myApplication,myApplication.getString(R.string.interstitial_ad_unit_id),request, interstitialAdLoadCallback);
    }
