...
public class FragmentStaus extends Fragment {
    ...
    public class Szr extends AsyncTask<Void,Void,Void> {
        com.dktechhub.mnnit.ee.whatsgb2.Status status;

        public Szr(com.dktechhub.mnnit.ee.whatsgb2.Status status)
        {
            this.status=status;
        }
    ...
    public static class Ldx extends AsyncTask<Void,com.dktechhub.mnnit.ee.whatsgb2.Status,Void> {
                ...
                if(list!=null)
                {
                    for (File f1 : list) {
                        if (isImage(f1.getAbsolutePath())) {
                            publishProgress(new com.dktechhub.mnnit.ee.whatsgb2.Status(f1.getAbsolutePath(),f1.getName(),"image/*"));

                        }else if(isVideo(f1.getAbsolutePath())){

                            publishProgress(new com.dktechhub.mnnit.ee.whatsgb2.Status(f1.getAbsolutePath(),f1.getName(),"video/*"));
        ...
        @Override
        protected void onProgressUpdate(com.dktechhub.mnnit.ee.whatsgb2.Status... values) {
    ...
    {   com.dktechhub.mnnit.ee.whatsgb2.Status status;
        public Dlx(com.dktechhub.mnnit.ee.whatsgb2.Status status)
        {
            this.status=status;
        }
