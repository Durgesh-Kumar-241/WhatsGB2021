...
public class MainActivityNew extends AppCompatActivity {
    ...
    public void rate(View view)
    {
        ...
        {
            startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://play.google.com/store/apps/details?id="+"com.dktechhub.mnnit.ee.whatsweb")));//Toast.makeText(getApplicationContext(), e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
        }
    }
